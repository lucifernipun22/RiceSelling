...
import static com.nipun.riceselling.fragment.HomeFragment.txt_countcard;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public boolean insertData(MyCart rModel) {
        if (getID(rModel.getPid(), rModel.getCost()) == -1) {
            ...
            contentValues.put(ICOL_2, rModel.getPid().toString());
            contentValues.put(ICOL_3, rModel.getImage().toString());
            contentValues.put(ICOL_4, rModel.getTitle().toString());
            contentValues.put(ICOL_5, rModel.getWeight().toString());
            contentValues.put(ICOL_6, rModel.getCost().toString());
            contentValues.put(ICOL_7, rModel.getQty().toString());
