...
public class GetResult {
    ...
    public void callForLogin(Call<JsonObject> call, String callno) {
        if(!Utiles.Utiles.INSTANCE.internetChack()){
            Toast.makeText(MyApplication.Companion.getMContext(), "Please Check Your Internet Connection", Toast.LENGTH_SHORT).show();
        }else {
