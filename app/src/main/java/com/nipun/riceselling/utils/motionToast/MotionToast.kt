...
import com.nipun.riceselling.databinding.FullColorToastBinding
import com.nipun.riceselling.databinding.MotionToastBinding
...
//                    binding.animate().alpha(0f).duration = 3000
        ...
        private fun setGravity(position: Int, toast: Toast) {
            if (position == GRAVITY_BOTTOM) {
                toast.setGravity(position, 0, 50)
            } else {
