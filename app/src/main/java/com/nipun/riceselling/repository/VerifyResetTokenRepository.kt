...
class VerifyResetTokenRepository(var baseActivity: BaseActivity) {

    private var verifyResponse = MutableLiveData<ForgetPasswordModel>()
    ...
    fun hitVerifyApi(
        ...
        if (Utiles.Utiles.internetChack()) {
            ...
            val call: Call<ForgetPasswordModel> =
                baseActivity.apiService!!.getVerifyResetToken(jsonObject)
