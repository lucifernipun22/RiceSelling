...
class AddAddressRepository(var baseActivity: BaseActivity) {

    private var couponRepository = MutableLiveData<ForgetPasswordModel>()
    ...
    fun hitAddAddress(
        ...
        if (Utiles.Utiles.internetChack()) {
            ...
            val call: Call<ForgetPasswordModel> =
                baseActivity.apiService!!.addAddress("Bearer ${token}",jsonObject)
